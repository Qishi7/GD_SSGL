...
root <- file.path(project_root, "new_method_comparison", "formal_simulation", "main_simulation", "no_spatial_deviation_beta0_0p5_100rep_perrep_tuned_intercept_svd")
...
report <- c(
  "# MGWR extension for beta0=0.5 no-spatial-deviation 100-replicate simulation",
  "",
  ...
  "- In this no-spatial-deviation scenario, `u_mise_x3_x6` is a spurious spatial variation metric on X3-X6.",
  "",
